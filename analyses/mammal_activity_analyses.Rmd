...
activity_corrs <- cor(select_if(activity_wide, is.numeric))  # cor and corrplot can only deal with numeric values, makes sense
...
coyote_full <- glmmTMB(activity_seconds ~ dist_jalama * human_seconds + (1|sitename) + (1|property), 
